...
export const books: Book[] = [
	{
		...
		description:
			'A neutral exploration of internal realities, where the mundane act of buying flowers opens into a complex web of memory, defiance, and the invisible lives of others.',
		status: 'Reviewed',
			...
			motifs: [
				{
					...
					description:
						'The disconnect between how individuals perceive themselves and how they are perceived by others.'
				},
				{
					title: 'Defiance vs. Conformity',
					description:
						'The tension between societal expectations and the private, powerful choices made to preserve one’s identity.'
				},
				{
					title: 'Generational Autonomy',
					description:
						'The subtle shift in perspective as younger characters seek independence from the rigid structures of the past.'
				}
			]
		}
	},
	{
		...
		author: 'Franz Kafka',
		description:
			'A surreal exploration of isolation and the human condition, following Gregor Samsa’s sudden transformation.',
		status: 'Reviewed',
		category: 'Classic Literature',
		collection: 'Classic',
		coverClass: 'bg-surface-accent',
		...
		fullReview: {
			...
			quote:
				"\"Father, Mother\", said his sister, [...], \"we can't carry on like this. Maybe you can't see it, but I can. I don't want to call this monster my brother, all I can say is: we have to try and get rid of it. We've done all that' humanly possible to look after it and be patient, I don't think anyone could accuse us of doing anything wrong.\"",
			motifs: [
				{
					title: 'Locked Doors and Thresholds',
					description:
						'These represent the physical and emotional barriers the family uses to isolate Gregor, turning his room into a prison as they slowly shut him out of their lives.'
				},
				{
					title: 'Food and Decay',
					description:
						"Gregor’s changing appetite—from fresh milk to rotting scraps—symbolizes his fading connection to human society and the family's transition from care to total neglect."
				},
				{
					title: 'Financial Debt and Value',
					description:
						"The constant focus on money highlights the transactional nature of the family's affection; Gregor is seen as valuable when he provides, but becomes a 'vermin' when he becomes a cost."
				}
			]
		}
	},
	{
		...
		description:
			'A lush, sensory-driven narrative exploring forbidden love and the intricacies of human desire.',
		status: 'Reading',
	...
	},
	{
		...
		description:
			'A touching story of three delinquents who hide in an abandoned store and begin receiving letters from the past.',
		status: 'Read',
		category: 'Fiction',
		collection: null,
		coverClass: 'bg-surface-accent',
	...
	},
	{
		...
		description:
			'In a small Tokyo cafe, customers can travel back in time, provided they return before their coffee gets cold.',
		status: 'Read',
	...
	},
	{
		...
		description:
			'A collection of poetic essays on the human condition, offering timeless wisdom on love, work, and joy.',
		status: 'Reviewed',
		category: 'Philosophy',
		collection: null,
		coverClass: 'bg-surface-accent',
	...
	},
	{
		...
		author: 'Neil Gaiman',
		description:
			'The story of a boy named Bod, who is raised by ghosts and other graveyard denizens after his family is murdered.',
		status: 'Read',
		category: 'Fantasy',
		collection: null,
		coverClass: 'bg-surface-accent',
	...
	},
	{
		...
		description:
			'A provocative exploration of how Homo sapiens came to dominate the Earth and the myths that hold us together.',
		status: 'Read',
